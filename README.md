...
- `wifi_6_board`: source files for the Wi-Fi 6 board, namely:  
  - firmware for the SiWG917 MCU, located in `fw/`  
  - CAD design files for the Wi-Fi 6 PCB shield, located in `hw/`  
...
- [Cédric Hirschi](https://www.linkedin.com/in/c%C3%A9dric-cyril-hirschi-09624021b/) (Full-stack Wi-Fi 6 shield design)  
...
- for all *software*(`*host_pc/, *.py`): [Apache License Version 2.0](licenses/LICENSE.sw)  
